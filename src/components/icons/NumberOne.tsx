...
function Leaf() {
  return (
    ...
    >
      ...
      <ellipse fill="#F2B851" cx="235.344" cy="177.512" rx="142.336" ry="141.36" />
      <ellipse fill="#D89D3D" cx="235.344" cy="177.512" rx="91.312" ry="90.688" />
      <g>
        <path
          fill="#FFFFFF"
